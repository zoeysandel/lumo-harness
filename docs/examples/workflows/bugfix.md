...
Goal: Reproduce or locate the failing behavior, make the smallest fix, then run the narrowest proof command.

Default: Prefer one failing case or fixture before changing implementation.
