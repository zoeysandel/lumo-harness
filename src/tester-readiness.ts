...
async function quickstartHasReproductionPath(repoRoot: string): Promise<ReadinessCheck> {
  ...
  const required = [
    /npm install/i,
    /npm run build/i,
    /npm run lumo -- doctor --path fixtures\/nextjs-pattern-following/i,
    /npm run lumo -- preflight --path fixtures\/nextjs-pattern-following/i,
    /control-layer-walkthrough\.md/i,
    /npm run preview:dashboard/i,
    /npm run eval:codex -- --case nextjs-stateful-ai-risk/i,
    /npm run eval:codex -- --case nextjs-ops-console-advanced-risk/i,
    /npm run eval:card/i,
    /What This Proves/i,
    /What This Does Not Prove/i,
  ];
